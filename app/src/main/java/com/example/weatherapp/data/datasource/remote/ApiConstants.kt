...
object ApiConstants {
    ...
    const val CURRENT_PARAMS = "temperature_2m,apparent_temperature,is_day,weather_code,wind_speed_10m,relative_humidity_2m,precipitation,precipitation_probability,uv_index,pressure_msl"
